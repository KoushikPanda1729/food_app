    ...
    return PopScope(
      ...
      child: GetBuilder<OrderController>(builder: (orderController) {
          ...
          if(orderController.orderDetails != null && order != null) {
            ...
            packagingPrice = order.totalPackagingCharge ?? 0;
          ...
          double total = itemsPrice + addOns - discount! + (taxIncluded! ? 0 : tax!) + deliveryCharge! - couponDiscount! + dmTips! + additionalCharge + extraPackagingCharge + packagingPrice - referrerBonusAmount;
