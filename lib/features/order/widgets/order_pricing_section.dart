...
class OrderPricingSection extends StatelessWidget {
  ...
  const OrderPricingSection({super.key, required this.itemsPrice, required this.addOns, required this.order, required this.subTotal, required this.discount,
    ...
    this.orderId, this.contactNumber, required this.extraPackagingAmount, required this.referrerBonusAmount, required this.packagingCharge,});
      ...
      child: Column(children: [
        ...
        Padding(
          ...
          child: Column(children: [
            ...
            (packagingCharge > 0) ? Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                Text('packaging_charge'.tr, style: robotoRegular),
                Text('(+) ${PriceConverter.convertPrice(packagingCharge)}', style: robotoRegular, textDirection: TextDirection.ltr),
              ],
            ) : const SizedBox(),
            SizedBox(height: packagingCharge > 0 ? 10 : 0),
