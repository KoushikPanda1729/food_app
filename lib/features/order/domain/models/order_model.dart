...
class OrderModel {
  ...
  OrderModel.fromJson(Map<String, dynamic> json) {
    ...
    totalPackagingCharge = json['total_packaging_charge']?.runtimeType == String
        ? double.parse(json['total_packaging_charge'].toString())
        : json['total_packaging_charge']?.toDouble();
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['total_packaging_charge'] = totalPackagingCharge;
    return data;
  }
}
