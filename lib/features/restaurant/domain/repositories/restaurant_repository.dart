...
class RestaurantRepository implements RestaurantRepositoryInterface {
  ...
  Future<RestaurantModel?> getList(
    ...
    switch (source!) {
      case DataSourceEnum.client:
        ...
        if (response.statusCode == 200) {
          restaurantModel = RestaurantModel.fromJson(response.body, restaurant);
      ...
      case DataSourceEnum.local:
        ...
        if (cacheResponseData != null) {
          restaurantModel = RestaurantModel.fromJson(
              jsonDecode(cacheResponseData), restaurant);
        }
    }
  ...
  Future<List<Restaurant>?> _getLatestRestaurantList(String type,
      {DataSourceEnum? source}) async {
  ...
  Future<List<Restaurant>?> _getPopularRestaurantList(String type,
      {DataSourceEnum? source}) async {
  ...
  Future<List<Restaurant>?> _getRecentlyViewedRestaurantList(String type,
      {DataSourceEnum? source}) async {
  ...
  Future<List<Restaurant>?> _getOrderAgainRestaurantList(
      {DataSourceEnum? source}) async {
