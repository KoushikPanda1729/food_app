        ...
        children: [
          Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            Row(children: [
              ...
              data![index].transactionType == 'order_place' || data![index].transactionType == 'partial_payment' || data![index].transactionType == 'shanghai_payment'
                  ? Image.asset(Images.debitIconWallet, height: 15, width: 15)
                  : Image.asset(Images.creditIconWallet, height: 15, width: 15),
              const SizedBox(width: Dimensions.paddingSizeExtraSmall),

              Text(data![index].transactionType == 'order_place' || data![index].transactionType == 'partial_payment' || data![index].transactionType == 'shanghai_payment'
            ...
            Text(
              data![index].transactionType == 'add_fund' ? '${'added_via'.tr} ${data![index].reference!.replaceAll('_', ' ')} ${data![index].adminBonus != 0 ? '(${'bonus'.tr} = ${data![index].adminBonus})' : '' }'
                  ...
                  : data![index].transactionType == 'shanghai_payment' ? data![index].transactionType == 'shanghai_payment' ? '${data![index].transactionType!.tr} ${'for'.tr} ${data![index].restaurant?.name ?? ''}' : '' :
                    data![index].transactionType!.tr,
              style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeSmall,color: Theme.of(context).hintColor),
              maxLines: 1, overflow: TextOverflow.ellipsis,
            ),

            if(data![index].transactionType == 'shanghai_payment') Text('${'via'.tr} ${data![index].reference!.replaceAll('_', ' ')}',
              style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeSmall,color: Theme.of(context).hintColor),
              maxLines: 1, overflow: TextOverflow.ellipsis,
            ),
          ]),
          ...
          Column(crossAxisAlignment: CrossAxisAlignment.end, children: [
            ...
            Text(
              data![index].transactionType == 'order_place' || data![index].transactionType == 'shanghai_payment' ? 'debit'.tr : 'credit'.tr,
