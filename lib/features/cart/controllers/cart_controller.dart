...
class CartController extends GetxController implements GetxService {
  ...
  double calculationCart(){
    ...
    for (var cartModel in _cartList) {
      ...
      _packagingPrice += cartModel.product?.category?.packagingPrice != null ? cartModel.product!.category!.packagingPrice! * cartModel.quantity! : 0;
      log(('packaging price :${cartModel.product?.category?.packagingPrice} * ${cartModel.quantity} = ${_packagingPrice}'), name: 'calculationCart');
