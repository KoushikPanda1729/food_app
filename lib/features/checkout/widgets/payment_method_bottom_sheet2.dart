...
class PaymentMethodBottomSheet2 extends StatefulWidget {
  ...
  State<PaymentMethodBottomSheet2> createState() =>
      _PaymentMethodBottomSheet2State();
}
  ...
  void initState() {
    ...
    if (Get.find<CheckoutController>().exchangeAmount > 0) {
      ...
      _amountController.text =
          Get.find<CheckoutController>().exchangeAmount.toString();
    }
    ...
    return SizedBox(
      ...
      child: GetBuilder<CheckoutController>(builder: (checkoutController) {
        return GetBuilder<BusinessController>(builder: (businessController) {
          bool disablePayments = checkoutController.paymentMethodIndex == 1 &&
              !checkoutController.isPartialPay;

          print(
              '======check: ${widget.isDigitalPaymentActive} && $notHideDigital && ${!checkoutController.subscriptionOrder}');
          return Container(
