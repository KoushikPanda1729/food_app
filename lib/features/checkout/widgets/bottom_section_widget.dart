            ...
            Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              SizedBox(
                  height: Get.find<SplashController>()
                      ...
                      : 0),
              if (packagingPrice > 0)
                Text('packaging_charge_for'.tr, style: robotoRegular),
              if (packagingPrice > 0)
              ...
              if (cartList != null)
                Column(
                  ...
                  children: cartList!.map<Widget>((cart) {
                    final packagingCharge =
                        (cart.product?.category?.packagingPrice ?? 0) *
                            cart.quantity!;
                    ...
                    return Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text(
                              ' ${cart.product?.category?.name ?? 'no name'} (${cart.quantity} ${'items'.tr} * ${PriceConverter.convertPrice(cart.product?.category?.packagingPrice ?? 0)})',
                              style: robotoRegular),
                          Text(
