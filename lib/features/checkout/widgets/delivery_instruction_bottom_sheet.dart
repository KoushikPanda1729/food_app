                  ...
                  suffixChild: InkWell(
                    onTap: customInstructionController.text.isNotEmpty ? () {
                      if (customInstructionController.text.isNotEmpty) {
                        checkoutController.additionalInstruction(customInstructionController.text);
                        setState(() {
                          selectIndex = checkoutController.deliveryInstructionList.length - 1;
                        });
                    ...
                    child: Container(
                      decoration: BoxDecoration(
                        color: customInstructionController.text.isNotEmpty ? Theme.of(context).primaryColor : Theme.of(context).disabledColor,
                        borderRadius: BorderRadius.circular(Dimensions.radiusSmall),
                      ),
