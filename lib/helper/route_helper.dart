...
import 'package:stackfood_multivendor/features/restaurant/screens/pay_restaurant_screen.dart';
...
class RouteHelper {
  ...
  static String getOrderSuccessRoute(
          ...
          {bool? isDeliveryOrder, bool? isShanghaiPay}) =>
      '$orderSuccess?id=$orderID&status=$status&amount=$amount&contact_number=$contactNumber&is_delivery_order=$isDeliveryOrder&is_shanghai_payment=$isShanghaiPay';
  static String getPaymentRoute(OrderModel orderModel, String? paymentMethod,
      ...
      int? restaurantId,
      int? packageId,
      String? shanghaiPayUri}) {
    String data = base64Encode(utf8.encode(jsonEncode(orderModel.toJson())));
    return '$payment?order=$data&payment-method=$paymentMethod&add-fund-url=$addFundUrl&subscription-url=$subscriptionUrl&guest-id=$guestId&number=$contactNumber&restaurant_id=$restaurantId&package_id=$packageId&shanghai_pay_uri=$shanghaiPayUri';
  }
  ...
  static String getPayRestaurantRoute({required Restaurant? restaurant}) {
    String data = 'null';
    if (restaurant != null) {
      data = base64Url.encode(utf8.encode(jsonEncode(restaurant.toJson())));
    }
    return '$payRestaurant?restaurant=$data';
  }
  ...
  static List<GetPage> routes = [
    ...
    GetPage(
        ...
        page: () {
          return getRoute(OrderSuccessfulScreen(
            isShanghaiPayment: Get.parameters['is_shanghai_payment'] == 'true',
    ...
    GetPage(
        ...
        page: () {
          ...
          if (Get.parameters['shanghai_pay_uri'] != null &&
              Get.parameters['shanghai_pay_uri'] != 'null') {
            shanghaiPayUri = Get.parameters['shanghai_pay_uri']!;
          }
    ...
    GetPage(
        ...
        page: () => getRoute(
              PayRestaurantScreen(
                  restaurant: Restaurant.fromJson(jsonDecode(utf8.decode(
                      base64Url.decode(Get.parameters['restaurant']!
                          .replaceAll(' ', '+')))))),
            )),
  ];
