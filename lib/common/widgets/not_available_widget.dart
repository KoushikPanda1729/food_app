...
class NotAvailableWidget extends StatelessWidget {
  ...
  const NotAvailableWidget({super.key, this.fontSize = 8, this.isRestaurant = false, this.opacity = 0.6, this.color = Colors.white, this.outSideZone = false});
  ...
  Widget build(BuildContext context) {
    return Positioned(
      ...
      child: Container(
        ...
        child: Text(
          outSideZone ? 'outside_zone'.tr : isRestaurant ? 'closed_now'.tr : 'not_available_now_break'.tr, textAlign: TextAlign.center,
